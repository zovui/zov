        ...
        >
            ...
            <div @click.stop="dropShow = true">
                ...
                <div class="zov-color-picker-values">
                    <div v-if="format === 'hex'" class="zov-color-picker-values-hex">
                        <Input
                ...
                <div
                    v-if="recommend"
                    class="zov-color-picker-recommend-colors"
                >
                    <div
                ...
                <div class="zov-color-picker-footer">
                    <Button size="small" @click.stop="cancelHandle">取消</Button>
                    <Button looks="primary" size="small" @click.stop="submitHandle">确定</Button>
                </div>
            </div>
        </Drop>
    </div>
...
export default {
    ...
    computed: {
        valueStyle () {
            return { 'background-color': this.disabled ? '#666666' : tinycolor(this.value).toRgbString() }
        },
        currentStyle () {
            return { 'background-color': tinycolor(this.formatColor).toRgbString() }
        },
        formatColor () {
