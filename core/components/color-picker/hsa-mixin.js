...
export default {
    ...
    methods: {
        ...
        getLeft (e) {
            const xOffset = this.$refs.container.getBoundingClientRect().left + window.pageXOffset
            const pageX = e.pageX || getTouches(e, 'PageX')
            return pageX - xOffset
        },
        getTop (e) {
            const yOffset = this.$refs.container.getBoundingClientRect().top + window.pageYOffset
