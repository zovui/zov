<template>
	<span v-if="data.length" class="zov-cascader-column">
		<div class="zov-cascader-column-inner">
			<div
				...
				:class="[
					'zov-select-option',
					{
						'zov-cascader-option-active':
							activeValues.indexOf(item['__' + valueName]) !== -1,
						'zov-cascader-option-selected':
							selectedValues.indexOf(item['__' + valueName]) !==
							-1
					}
				]"
