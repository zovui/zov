                    ...
                    <div v-if="queryResult.length">
                        <div
                            ...
                            :class="[
                                'zov-select-option',
                                {
                                    'zov-cascader-option-selected': currentValueArr.indexOf(item['__' + valueName]) !== -1
                                }
                            ]"
                            v-if="canSelect(item)"
                            @click.stop.capture="activeItem(item)"
                        >
                        <span v-html="item['__' + labelName].replace(
                            item[labelName]
                            , `
                            ...
                            <Icon
                                ...
                                v-if="currentValueArr.indexOf(item['__' + valueName]) !== -1"
                                iconname="checkmark"
                            />
                        </div>
                    </div>
