<template>
    <div style="text-align: center">
        ...
        <p>
            ...
            <Tag :size="size" shape="circle" looks="primary" disabled>primary</Tag>
            <Tag :size="size" shape="circle" looks="dashed" disabled>dashed</Tag>
            <Tag :size="size" shape="circle" looks="text" disabled>text</Tag>
            <Tag :size="size" shape="circle" looks="info" disabled>info</Tag>
            <Tag :size="size" shape="circle" looks="success" disabled>success</Tag>
            <Tag :size="size" shape="circle" looks="warning" disabled>warning</Tag>
        ...
        <p>
            loading 异步
            <Tag :loading="loading" @click="loading = !loading">点击我 等待</Tag>
            ...
            <Tag :loading="loading" :size="size" shape="circle" looks="primary">primary</Tag>
            <Tag :loading="loading" :size="size" shape="circle" looks="dashed">dashed</Tag>
            <Tag :loading="loading" :size="size" shape="circle" looks="text">text</Tag>
            <Tag :loading="loading" :size="size" shape="circle" looks="info">info</Tag>
            <Tag :loading="loading" :size="size" shape="circle" looks="success">success</Tag>
            <Tag :loading="loading" :size="size" shape="circle" looks="warning">warning</Tag>
            <Tag :loading="loading" :size="size" shape="circle" looks="error">error</Tag>
        </p>
        <p>
            无文本 tag
            <Tag loading />
        ...
        <p>
            一组tag
            <Tag v-for="(item, index) in tags" :key="index" @on-close="removeTage(index)">
                {{ item.text }}
            </Tag>
        </p>
    </div>
