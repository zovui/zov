<template>
    <div>
        ...
        <Button @click="thumbnail = !thumbnail"> 缩略图 {{ thumbnail }} </Button>
        <div>
            <Menu
                :mode="mode"
        ...
        <div style="border: 3px dashed; text-align: left; margin: 15px;padding: 15px">
            ...
            <p>@active-name                         非必传，[Number, String]，当前激活的MenuOption，默认: undefined<br>
                <span style="color: green">说明：如果当前MenuOption是在未展开的MenuSub项中，则会将其所有父级MenuSub展开</span>
            </p>
